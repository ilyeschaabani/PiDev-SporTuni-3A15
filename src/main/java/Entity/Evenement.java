...
public class Evenement {
    ...
    public Evenement(int id_e, String nom_e, String nom_salle, Date dateDebut, String nom_discipline, String description, int nbr_max, Date dateFin) {
        this.id_e = id_e;
        this.nom_e = nom_e;
        this.nom_salle = nom_salle;
        this.dateDebut=dateDebut;
    ...
    public Evenement(String nom_e, String nom_salle, Date dateDebut, String nom_discipline, String description, int id_u, int nbr_max, Date dateFin) {
        this.nom_e = nom_e;
        this.nom_salle = nom_salle;
        this.dateDebut = dateDebut;
        this.nom_discipline = nom_discipline;
    ...
    public Evenement(String nomE, String nom, Date date, String nomDiscipline, String descriptionVal, int nbrMax, Date date1) {
        this.nom_e = nomE;
        this.nom_salle = nom;
        this.dateDebut = date;
